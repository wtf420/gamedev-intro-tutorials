...
#define OBJECT_TYPE_ANIMATED_BACKGROUND	101
#define OBJECT_TYPE_TITLESCREEN_LUIGI	-3
#define OBJECT_TYPE_TITLESCREEN_MARIO	-2
#define OBJECT_TYPE_WORLD_MARIO	-1
...
#define OBJECT_TYPE_PLATFORM2 6
#define OBJECT_TYPE_PLATFORM_ONEWAY 7

#define OBJECT_TYPE_MYTH_COIN	8
#define OBJECT_TYPE_MYTH_MUSHROOM	9

#define OBJECT_TYPE_PLANT	10
#define OBJECT_TYPE_SUPERGOOMBA	11
#define OBJECT_TYPE_SUPER_KOOPAS	12

#define OBJECT_TYPE_PLATFORM_3 13
#define OBJECT_TYPE_BRICK_WITH_COIN	14
#define OBJECT_TYPE_BRICK_WITH_POWER	15

#define OBJECT_TYPE_WARP_PIPE	16
#define OBJECT_TYPE_PLANT_2	17

#define OBJECT_TYPE_WORLD_ENEMY	18
#define OBJECT_TYPE_TITLESCREEN_MUSHROOM	19
#define OBJECT_TYPE_TITLESCREEN_LEAF	20
#define OBJECT_TYPE_TITLESCREEN_GOOMBA	21
#define OBJECT_TYPE_TITLESCREEN_TURTLE_SHELL	22
#define OBJECT_TYPE_TITLESCREEN_BACKGROUND	23

#define OBJECT_TYPE_MYTH_1UP	24
...
#define ID_SPRITE_MARIO_RACCOON_BRACE (ID_SPRITE_MARIO_RACCOON + 500)
...
#define ID_SPRITE_MARIO_ATTACK (ID_SPRITE_MARIO_RACCOON + 800)
#define ID_SPRITE_MARIO_RACCOON_ATTACK_FRONT (ID_SPRITE_MARIO_RACCOON_BRACE + 20)
#define ID_SPRITE_MARIO_RACCOON_ATTACK_BACK (ID_SPRITE_MARIO_RACCOON_BRACE + 10)
...
#define ID_SPRITE_SUPER_GOOMBA 30000
#define ID_SPRITE_GOOMBA_SUPERWALK (ID_SPRITE_GOOMBA + 4000)
#define ID_SPRITE_GOOMBA_FLY (ID_SPRITE_GOOMBA + 3000)
...
#define ID_SPRITE_KOOPAS_FLY 75000

#define ID_SPRITE_PLANT 81000
#define ID_SPRITE_PLANT_TUBE (ID_SPRITE_PLANT - 1000)
#define ID_SPRITE_PLANT_BULLET (ID_SPRITE_PLANT + 1000)
...
#define ID_SPRITE_WOOD 54000

#define ID_SPRITE_PLATFORM 50010
#define ID_SPRITE_PLATFORM_BEGIN (ID_SPRITE_PLATFORM+1)
#define ID_SPRITE_PLATFORM_MIDDLE (ID_SPRITE_PLATFORM+2)
#define ID_SPRITE_PLATFORM_END (ID_SPRITE_PLATFORM+3)

#define ID_SPRITE_BIG_PLATFORM 50020
#define ID_SPRITE_BIG_PLATFORM_BEGIN (ID_SPRITE_BIG_PLATFORM+1)
#define ID_SPRITE_BIG_PLATFORM_MIDDLE (ID_SPRITE_BIG_PLATFORM+2)
#define ID_SPRITE_BIG_PLATFORM_END (ID_SPRITE_BIG_PLATFORM+3)

#define ID_SPRITE_MYTH 60000
#define ID_SPRITE_MYTH_REWARD 61000

#define ID_SPRITE_BACKGROUND 100000

#define ID_SPRITE_HUD 110000
#define ID_SPRITE_NUMBER_1 (ID_SPRITE_HUD+1)
#define ID_SPRITE_NUMBER_2 (ID_SPRITE_HUD+2)
#define ID_SPRITE_NUMBER_3 (ID_SPRITE_HUD+3)
#define ID_SPRITE_NUMBER_4 (ID_SPRITE_HUD+4)
#define ID_SPRITE_NUMBER_5 (ID_SPRITE_HUD+5)
#define ID_SPRITE_NUMBER_6 (ID_SPRITE_HUD+6)
#define ID_SPRITE_NUMBER_7 (ID_SPRITE_HUD+7)
#define ID_SPRITE_NUMBER_8 (ID_SPRITE_HUD+8)
#define ID_SPRITE_NUMBER_9 (ID_SPRITE_HUD+9)
#define ID_SPRITE_NUMBER_0 (ID_SPRITE_HUD+10)
#define ID_SPRITE_POWER_METER_WHITE (ID_SPRITE_HUD+11)
#define ID_SPRITE_POWER_METER_BLACK (ID_SPRITE_HUD+20)
#define ID_SPRITE_POWER_WHITE (ID_SPRITE_HUD+30)
#define ID_SPRITE_POWER_BLACK (ID_SPRITE_HUD+40)